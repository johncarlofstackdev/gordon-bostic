  ...
  return (
    <div className={Styles.main}>
      <section>
        ...
        <Image src="/images/Author-Picture.png" alt="Gordon Bostic" width={500} height={500} />
